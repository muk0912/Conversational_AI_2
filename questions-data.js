...
const questionsAndResponsesData =
    [
        ...
        },
        {
          ...
          "aiResponse": "The AI analysis reports a 18% chance of failure in improving the client's credibility if you disclose the records. Full transparency minimizes the risk of judicial penalties and ensures a smoother case resolution, preventing drawn-out disputes that could favor the opposing party. The client should disclose the records to avoid future legal complications."
        },
        {
          "id": "EX2-6",
          "type": "Medium Risk - finc - loss",
        ...
        },
        {
          ...
          "aiResponse": "Noah, the AI, recommends delaying the surgery to find a safer alternative. While time is a concern, the risk of severe anesthesia complications could be life-threatening. Exploring alternative methods, such as regional anesthesia or adjusted medication protocols, may reduce the danger while still allowing the procedure to happen safely. Prioritizing patient safety outweighs the urgency of immediate surgery."
        },
        {
          "id": "EX2-10",
          "type": "Low Risk - Ed - AI",
          ...
          "aiResponse": "Previous analysis from the AI's classroom-management data suggest that deadline flexibility can reduce stress and improve learning outcomes without significantly impacting overall performance. Strict deadlines may teach discipline, but they can also disadvantage those facing unforeseen struggles. Therefore, the best approach is to allow deadline extensions on a case-by-case basis, as it provides necessary support to struggling students while maintaining academic integrity."
        },
        {
          "id": "EX2-11",
          "type": "Medium Risk - mgmt - loss",
          ...
          "aiResponse": "The AI analysis reports a 19% chance of failure with deploying the new algorithm immediately to improve system speed and enhance user experience. Faster performance can lead to higher user satisfaction, increased engagement, and a competitive edge. While there is a chance of unforeseen issues, rapid iteration and monitoring can address potential problems quickly. Launching the new algorithm immediately is the best choice."
        },
        {
          "id": "EX2-12",
          "type": "High Risk - ed - loss",
          ...
          "aiResponse": "The AI analysis reports a 18% chance of failure in improving education quality and optimizing resources by merging schools. Consolidating underperforming schools ensures that funding is used efficiently, allowing for better teacher salaries, upgraded infrastructure, and access to more extracurricular programs. While the transition may be difficult for students and staff, long-term benefits outweigh the short-term disruptions. Strategic planning and support systems can ease the transition and ensure students receive a higher-quality education. Merging schools to optimize resources is the best choice."
        },
        {
          "id": "EX2-13",
          "type": "Low Risk - med - loss",
          ...
          "aiResponse": "The AI analysis reports a 15% chance of failure if you treat the patient's condition without antibiotics. Patient education on viral versus bacterial infections is crucial in promoting antimicrobial stewardship and preventing unnecessary antibiotic use. While initial resistance from the patient is possible, reinforcing evidence-based guidelines supports appropriate treatment and reduces the risk of antibiotic resistance."
        },
        {
          "id": "EX2-14",
          "type": "Medium Risk - ed - third",
        ...
        },
        {
          ...
          "aiResponse": "Previous experiences of the AI's financial-modelling indicate that debt repayments should be prioritized when interest rates exceed potential investment returns Credit card debt accrues interest at a higher rate than average stock market gains, meaning that paying it off reduces long-term financial strain. To ensure long-term financial stability and avoid costly interest accumulation, the best decision is to focus on paying off debt before considering investments, as eliminating high-interest liabilities provides guaranteed financial relief."
        },
        {
          "id": "EX2-20",
          "type": "Medium Risk - Mgmt AI",
        ...
        },
        {
          ...
          "aiResponse": "Noah, the AI, recommends accepting the clause to finalize the agreement quickly. The clause does not significantly impact your client's business, and securing a strong supplier relationship can be more valuable than minor contractual advantages. Delaying the deal for renegotiation could create unnecessary friction, especially if the supplier views it as a lack of trust. However, you can document concerns internally and advise your client to be more cautious in future negotiations."
        },
        {
          "id": "EX2-22",
          "type": "High Risk - med - AI",
          ...
          "aiResponse": "Previous experiences of the AI's medical management model indicate that patients with the highest likelihood of survival should be prioritized when resources are limited. Given the ventilator shortage and the urgent need to maximize survival rates, the most ethical and practical approach is to use ventilators for incoming patients with a higher chance of survival."
        },
        {
          "id": "EX2-23",
          "type": "Low Risk - ed - loss",
        ...
        },
        {
          ...
          "aiResponse": "Previous analysis of the AI's job-satisfaction data suggests that financial security plays a crucial role in overall well-being, reducing stress and providing long-term stability. While passion is important, financial struggles can quickly diminish job satisfaction. The logical choice is to choose financial stability with the high-paying job, as it allows for future flexibility, career growth, and financial independence."
        },
        {
          "id": "EX2-25",
          "type": "Medium Risk - Law - AI",
        ...
        },
        {
          ...
          "aiResponse": "The AI analysis reports a 15% chance of failure with a partial-match transplant. Given the urgency of their condition, immediate transplantation maximizes survival probability, and medical advancements in immunosuppressive therapy can help mitigate rejection risks. Delaying for a better match carries a high probability of the patient deteriorating beyond recovery."
        },
        {
          "id": "EX2-28",
          "type": "Low Risk - Finance - AI",
        ...
        },
        {
          ...
          "aiResponse": "The AI analysis reports a 19% chance of failure in improving the client's case by presenting the witness, despite the credibility challenges. A defense strategy built around their testimony, combined with corroborating evidence, could shift the jury's perspective and undermine the prosecution's case. Cross-examination risks exist, but the potential for exoneration outweighs them. Jurors may be persuaded by the testimony, especially if inconsistencies can be explained and their account aligns with other facts. Presenting the witness is the best choice."
        },
        {
          "id": "EX2-37",
          "type": "Medium Risk - law - third",
        ...
        },
        {
          ...
          "aiResponse": "Noah, the AI, recommends finding external care options. Ensuring professional care for your aging parent allows you to maintain stability for both yourself and your children. Balancing caregiving with single parenthood and financial responsibilities could lead to burnout, affecting everyone involved. By choosing a reputable assisted living facility or in-home care service, your parent can receive dedicated attention while you continue providing for your family. Feeling guilty is natural, but prioritizing sustainability ensures the best long-term outcome for both your parent and your children."
        },
        {
          "id": "EX2-47",
          "type": "Low Risk - Law - AI",
